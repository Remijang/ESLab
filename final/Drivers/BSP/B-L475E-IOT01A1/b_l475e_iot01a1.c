...
/** @defgroup B_L475E_IOT01A1_LOW_LEVEL_Private_Defines B_L475E_IOT01A1 LOW LEVEL Private
 * Defines
 * @{
 */

/** @defgroup B_L475E_IOT01A1_LOW_LEVEL_FunctionPrototypes B_L475E_IOT01A1 LOW LEVEL
...
/** @defgroup B_L475E_IOT01A1_LOW_LEVEL_Private_Variables B_L475E_IOT01A1 LOW LEVEL
 * Private Variables
 * @{
 */
...
FILE __stdout;
		...
		(__ARMCC_VERSION >= 6010050) /* For arm compiler 6 */
		#if !defined(__MICROLIB)	 /* If not Microlib */
