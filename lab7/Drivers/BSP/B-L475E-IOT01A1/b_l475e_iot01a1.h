...
#define __B_L475E_IOT01A1_BSP_VERSION_RC           \
	(uint32_t)(0x00) /*!< [7:0]  release candidate \
					  */
#define __B_L475E_IOT01A1_BSP_VERSION             \
	((__B_L475E_IOT01A1_BSP_VERSION_MAIN << 24) | \
	 (__B_L475E_IOT01A1_BSP_VERSION_SUB1 << 16) | \
	 (__B_L475E_IOT01A1_BSP_VERSION_SUB2 << 8) | (__B_L475E_IOT01A1_BSP_VERSION_RC))

/** @defgroup B_L475E_IOT01A1_LOW_LEVEL_Exported_Types B_L475E_IOT01A1 LOW LEVEL Exported
 * Types
 * @{
 */
...
/** @defgroup B_L475E_IOT01A1_LOW_LEVEL_Exported_Variables LOW LEVEL Exported
 * Constants
 * @{
 */
...
/** @defgroup B_L475E_IOT01A1_LOW_LEVEL_Exported_Functions B_L475E_IOT01A1 LOW LEVEL
 * Exported Functions
 * @{
 */
